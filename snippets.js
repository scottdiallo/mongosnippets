...
MongoClient.connect('mongodb://localhost/snippets', function(err, db) {
    ...
    var create = function(name, content) { // creating snippet in the  database
        var snippet = {
            name: name,
            content: content
        };
...
var update = {
    $set: {content: content} // setting the value of the field
};

collection.findAndModify(query, null, update, function(err, // method to find and update snippets
     result) {
...
// delete method to find and remove snippet
